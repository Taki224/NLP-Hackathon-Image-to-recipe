...
CHECKPOINT_DIR = PROJECT_ROOT / 'final_run/models/checkpoints/phase2_74k'
CHECKPOINT_PATH = CHECKPOINT_DIR / 'best_model.ckpt'
LAST_CHECKPOINT_PATH = CHECKPOINT_DIR / 'last.ckpt'

INDEX_PATH = PROJECT_ROOT / 'final_run/data/indexes/recipe_index_phase2_74k.npy'
INDEX_IDS_PATH = PROJECT_ROOT / 'final_run/data/indexes/recipe_index_ids_phase2_74k.npy'
INDEX_META_PATH = PROJECT_ROOT / 'data/indexes/recipe_index_metadata_newdata3.json'

PAIRED_DATASET_PATH = PROJECT_ROOT / 'final_run/data/datasets/paired_dataset_70k_train.json'
...
if metrics_path.exists():
    ...
    if len(loss_values) > 0:
        ...
        plt.savefig(FIGURES_DIR / 'training_loss_phase2_74k.png', dpi=100)
        plt.show()
    else:
